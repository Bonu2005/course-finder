 ...
 *         description: Server xatosi
 */
resourseRouter.post("/", verifyToken, verifyRole(["admin", "user"]), upload.single("photo"), create)
 ...
 *         description: Server xatosi
 */
resourseRouter.patch("/:id", verifyToken, verifyRole(["admin", "user"]), upload.single("photo"), update)
