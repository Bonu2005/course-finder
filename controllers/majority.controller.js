...
async function findOne(req,res) {
    try {
        let {id}= req.params
        let dat=await MajorityItem.findAll({include:[{model:Center},{model:Majority}]})
        let something = await Center.findAll({include:Region})
...
async function create(req,res) {
    try {
        ...
        let create = await Majority.create({...data})
